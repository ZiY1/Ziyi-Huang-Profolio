...
const title = 'Ziyi Huang'
const description =
    "👋 Hello! I'm Ziyi Huang, a passionate Full Stack Developer who loves cats. Explore my portfolio and contact me on GitHub."
const url = BASE_URL
    ...
    return (
        <html lang="en" suppressHydrationWarning>
            <head>
                ...
                <meta
                    name="keywords"
                    content="Ziyi Huang, Full Stack Developer, Backend Developer, Portfolio, GitHub"
                />
